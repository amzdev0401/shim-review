...
*******************************************************************************
SHIM Created from https://github.com/rhboot/shim/releases/download/15.8/shim-15.8.tar.bz2
...
*******************************************************************************
https://github.com/rhboot/shim/releases/download/15.8/shim-15.8.tar.bz2 source code with only Amzetta Technologies certificate is embedded
...
*******************************************************************************
No, we're not setting the NX compatibility bit.
